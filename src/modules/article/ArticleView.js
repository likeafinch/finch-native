  ...
  const _renderRecommendationCard = ({ item }) => (
    <TouchableOpacity style={styles.recommendationItem}>
      ...
      <Image
        ...
        source={require('../../../assets/images/inanis_umbra_wide.png')}
        resizeMode="contain"
      />
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.carouselContainer}>
        <Carousel
          ...
          data={[
            require('../../../assets/images/inanis_umbra_wide.png'),
            require('../../../assets/images/inanis_umbra_wide2.jpg'),
          ]}
        />
        {itemParams.badge && (
